;; fitvault-core.clar
;; This contract serves as the central hub for the FitVault fitness platform, handling
;; user registration, workout logging, and participation in group fitness challenges.
;; It maintains secure workout records and manages fitness challenge participation
